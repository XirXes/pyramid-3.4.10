...
void pyramid_snddev_poweramp_on(int en)
{
	...
	if (en) {
		...
		gpio_direction_output(PM8058_GPIO_PM_TO_SYS(PYRAMID_AUD_SPK_ENO), 1);
	} else {
		
		gpio_direction_output(PM8058_GPIO_PM_TO_SYS(PYRAMID_AUD_SPK_ENO), 0);
	}
}
...
void pyramid_snddev_receiver_pamp_on(int en)
{
	...
	if (en) {
		...
		gpio_direction_output(PM8058_GPIO_PM_TO_SYS(PYRAMID_AUD_HANDSET_ENO), 1);
	} else {
		
		gpio_direction_output(PM8058_GPIO_PM_TO_SYS(PYRAMID_AUD_HANDSET_ENO), 0);
	}
}
...
void pyramid_snddev_emic_pamp_on(int en)
{
	...
	if (en) {
		...
		gpio_request(PM8058_GPIO_PM_TO_SYS(PYRAMID_AUD_2V85_EN), "AUD_2V85_EN");
		gpio_direction_output(PM8058_GPIO_PM_TO_SYS(PYRAMID_AUD_2V85_EN), 1);
	} else {
		gpio_request(PM8058_GPIO_PM_TO_SYS(PYRAMID_AUD_2V85_EN), "AUD_2V85_EN");
		gpio_direction_output(PM8058_GPIO_PM_TO_SYS(PYRAMID_AUD_2V85_EN), 0);
	}
#endif
}
...
{
	pr_aud_info("%s\n", __func__);
	gpio_request(PM8058_GPIO_PM_TO_SYS(PYRAMID_AUD_SPK_ENO), "AUD_SPK_ENO");
	gpio_request(PM8058_GPIO_PM_TO_SYS(PYRAMID_AUD_HANDSET_ENO), "AUD_HANDSET_ENO");
}
