...
static void config_flashlight_gpios(void)
{
	static uint32_t flashlight_gpio_table[] = {
		GPIO_CFG(PYRAMID_FLASH_EN, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
		GPIO_CFG(PYRAMID_FLASH_TORCH, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
		GPIO_CFG(PYRAMID_FLASH_RST, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	};
	...
	gpio_set_value(PYRAMID_FLASH_RST, 1);
}

static struct TPS61310_flashlight_platform_data flashlight_data = {
	.gpio_init = config_flashlight_gpios,
	.tps61310_strb1 = PYRAMID_FLASH_TORCH,
	.tps61310_strb0 = PYRAMID_FLASH_EN,
...
static uint32_t mhl_usb_switch_ouput_table[] = {
	GPIO_CFG(PYRAMID_GPIO_MHL_USB_SW, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_4MA),
};
...
static void pyramid_usb_dpdn_switch(int path)
{
	...
	case PATH_MHL:
	{
		...
		gpio_set_value(PYRAMID_GPIO_MHL_USB_SW, (mhl ^ !polarity) ? 1 : 0);
		break;
	}
	}
...
static uint32_t mhl_gpio_table[] = {
	...
	GPIO_CFG(PYRAMID_GPIO_MHL_WAKE_UP, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
};
...
static uint32_t gsbi3_gpio_table[] = {
	GPIO_CFG(PYRAMID_GPIO_FL_I2C_SDA, 1, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_8MA),
	GPIO_CFG(PYRAMID_GPIO_FL_I2C_SCL, 1, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_8MA),
};

static uint32_t gsbi3_gpio_table_gpio[] = {
	GPIO_CFG(PYRAMID_GPIO_FL_I2C_SDA, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_8MA),
	GPIO_CFG(PYRAMID_GPIO_FL_I2C_SCL, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_8MA),
};
...
static uint32_t gsbi5_gpio_table[] = {
	GPIO_CFG(PYRAMID_GPIO_TP_I2C_SDA, 1, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_8MA),
	GPIO_CFG(PYRAMID_GPIO_TP_I2C_SCL, 1, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_8MA),
};

static uint32_t gsbi5_gpio_table_gpio[] = {
	GPIO_CFG(PYRAMID_GPIO_TP_I2C_SDA, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_8MA),
	GPIO_CFG(PYRAMID_GPIO_TP_I2C_SCL, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_8MA),
};
...
static uint32_t gsbi8_gpio_table[] = {
	GPIO_CFG(PYRAMID_GPIO_QTR_SDA, 1, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_8MA),
	GPIO_CFG(PYRAMID_GPIO_QTR_SCL, 1, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_8MA),
};

static uint32_t gsbi8_gpio_table_gpio[] = {
	GPIO_CFG(PYRAMID_GPIO_QTR_SDA, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_8MA),
	GPIO_CFG(PYRAMID_GPIO_QTR_SCL, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_8MA),
};
...
static uint32_t gsbi12_gpio_table[] = {
	GPIO_CFG(PYRAMID_GPIO_CAP_I2C_SDA, 2, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIOMUX_DRV_8MA),
	GPIO_CFG(PYRAMID_GPIO_CAP_I2C_SCL, 2, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIOMUX_DRV_8MA),
};

static uint32_t gsbi12_gpio_table_gpio[] = {
	GPIO_CFG(PYRAMID_GPIO_CAP_I2C_SDA, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_8MA),
	GPIO_CFG(PYRAMID_GPIO_CAP_I2C_SCL, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_8MA),
};
...
static struct i2c_board_info msm_i2c_gsbi5_info[] = {
	{
		...
		.irq = MSM_GPIO_TO_INT(PYRAMID_GPIO_TP_ATTz)
	},
};
...
static int cy8c_cs_reset(void)
{
	...
	gpio_set_value_cansleep(PYRAMID_GPIO_CAP_RST, 1);
	msleep(5);
	gpio_set_value_cansleep(PYRAMID_GPIO_CAP_RST, 0);
...
static struct cy8c_i2c_cs_platform_data cs_cy8c_data[] = {
	{
		.gpio_irq     = PYRAMID_GPIO_CAP_ATTz,
		.gpio_rst     = PYRAMID_GPIO_CAP_RST,
		.reset        = cy8c_cs_reset,
...
static struct i2c_board_info msm_i2c_gsbi12_info[] = {
	{
		...
		.irq = MSM_GPIO_TO_INT(PYRAMID_GPIO_CAP_ATTz),
	},
};
...
static uint32_t headset_cpu_gpio[] = {
	GPIO_CFG(PYRAMID_AUD_UART_RX, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	GPIO_CFG(PYRAMID_AUD_UART_TX, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	GPIO_CFG(PYRAMID_AUD_UART_RX, 1, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	GPIO_CFG(PYRAMID_AUD_UART_TX, 1, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
};
...
static void uart_tx_gpo(int mode)
{
	switch (mode) {
		case 0:
			...
			gpio_set_value_cansleep(PYRAMID_AUD_UART_TX, 0);
			break;
		case 1:
			gpio_tlmm_config(headset_cpu_gpio[1], GPIO_CFG_ENABLE);
			gpio_set_value_cansleep(PYRAMID_AUD_UART_TX, 1);
			break;
		case 2:
...
{
	gpio_set_value_cansleep(PM8058_GPIO_PM_TO_SYS(PYRAMID_AUD_UART_OE), enable);
}

static struct htc_headset_1wire_platform_data htc_headset_1wire_data = {
	.tx_level_shift_en	= PM8058_GPIO_PM_TO_SYS(PYRAMID_AUD_UART_OE),
	.uart_sw		= 0,
...
static void headset_init(void)
{
	...
	gpio_tlmm_config(GPIO_CFG(PYRAMID_AUD_UART_TX, 1, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA), 0);
	gpio_tlmm_config(GPIO_CFG(PYRAMID_AUD_UART_RX, 1, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA), 0);
}
...
static void headset_power(int enable)
{
	...
	int rc;
		...
		ret = gpio_request(PM8058_GPIO_PM_TO_SYS(PYRAMID_AUD_2V85_EN), "HS_MIC_BIAS");
		if (ret)
			pr_err("[HS]Request Headset MIC bias error\n");
		else {
		ret = gpio_direction_output(PM8058_GPIO_PM_TO_SYS(PYRAMID_AUD_2V85_EN), enable);
		if (ret)
			pr_err("[HS]Set MIC bias to %d error\n", enable);
		gpio_free(PM8058_GPIO_PM_TO_SYS(PYRAMID_AUD_2V85_EN));
		}
...
static int pm8058_gpios_init(void)
{
	...
	struct pm8058_gpio_cfg gpio_cfgs[] = {
...
#ifdef CONFIG_MSM8X60_AUDIO 
		{ 
			PM8058_GPIO_PM_TO_SYS(PYRAMID_AUD_HANDSET_ENO),
			{
		...
		{ 
			PM8058_GPIO_PM_TO_SYS(PYRAMID_AUD_SPK_ENO),
			{
				.direction	= PM_GPIO_DIR_OUT,
				.output_value	= 0,
				.output_buffer	= PM_GPIO_OUT_BUF_CMOS,
		...
		{ 
			PM8058_GPIO_PM_TO_SYS(PYRAMID_AUD_UART_OE),
			{
				.direction	= PM_GPIO_DIR_OUT,
				.output_value	= 1,
				.output_buffer	= PM_GPIO_OUT_BUF_CMOS,
		...
		{
			PM8058_GPIO_PM_TO_SYS(PYRAMID_AUD_2V85_EN),
			{
				.direction	= PM_GPIO_DIR_OUT,
				.output_value	= 0,
				.output_buffer	= PM_GPIO_OUT_BUF_CMOS,
		...
		{
			PM8058_GPIO_PM_TO_SYS(PYRAMID_PS_VOUT),
			{
				.direction      = PM_GPIO_DIR_IN,
				.pull           = PM_GPIO_PULL_NO,
				.vin_sel        = PM8058_GPIO_VIN_L5, 
...
static struct tpa2051d3_platform_data tpa2051d3_pdata = {
	.gpio_tpa2051_spk_en = PM8058_GPIO_PM_TO_SYS(PYRAMID_AUD_SPK_ENO),
...
static struct cm3629_platform_data cm36282_pdata = {
	...
	.intr = PM8058_GPIO_PM_TO_SYS(PYRAMID_PS_VOUT),
...
static struct i2c_board_info i2c_CM36282_devices[] = {
	{
		...
		.irq =  PM8058_GPIO_IRQ(PM8058_IRQ_BASE, PYRAMID_PS_VOUT),
	},
};
#endif
