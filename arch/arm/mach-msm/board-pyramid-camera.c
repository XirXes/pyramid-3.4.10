...
static struct regulator *pyramid_reg_8058_l8 = NULL;
...
static int pyramid_rawchip_vreg_on(void)
{
	int rc;
	pr_info("[CAM] %s\n", __func__);

	
	rc = camera_sensor_power_enable("8058_l14", 2850000, &pyramid_reg_8058_l14);
	...
	rc = camera_sensor_power_enable("8058_l8", 1800000, &pyramid_reg_8058_l8);
	...
	rc = gpio_request(PYRAMID_GPIO_V_CAM_D1V2_EN, "CAM_D1V2");
	if (rc < 0) {
		pr_err("[CAM] sensor_power_enable(\"gpio %d\", 1.2V) FAILED %d\n", PYRAMID_GPIO_V_CAM_D1V2_EN, rc);
		goto enable_1v2_fail;
	}
	gpio_direction_output(PYRAMID_GPIO_V_CAM_D1V2_EN, 1);
	gpio_free(PYRAMID_GPIO_V_CAM_D1V2_EN);
...
lcmio_hi_fail:
	camera_sensor_power_disable(pyramid_reg_8058_l9);
enable_analog_fail:
	gpio_request(PYRAMID_GPIO_V_CAM_D1V2_EN, "CAM_D1V2_EN");
	gpio_direction_output(PYRAMID_GPIO_V_CAM_D1V2_EN, 0);
	gpio_free(PYRAMID_GPIO_V_CAM_D1V2_EN);
enable_1v2_fail:
	camera_sensor_power_disable(pyramid_reg_8058_l8);
enable_1v8_fail:
	camera_sensor_power_disable(pyramid_reg_8058_l14);
enable_VCM_fail:
	return rc;
}
static void config_rawchip_off_gpios(void);
static int pyramid_rawchip_vreg_off(void)
{
	int rc = 0;
	...
	rc = gpio_request(PYRAMID_GPIO_V_CAM_D1V2_EN, "RAW_1V2_EN");
	if (rc < 0) {
		pr_err("[CAM] sensor_power_enable(\"gpio %d\", 1.2V) FAILED %d\n", PYRAMID_GPIO_V_CAM_D1V2_EN, rc);
		goto ville_rawchip_vreg_off_fail;
	}
	...
	rc = camera_sensor_power_disable(pyramid_reg_8058_l8);
	...
	rc = camera_sensor_power_disable(pyramid_reg_8058_l14);
...
static uint32_t rawchip_on_gpio_table[] = {
	GPIO_CFG(PYRAMID_GPIO_RAW_RSTN, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA), 
	GPIO_CFG(PYRAMID_GPIO_RAW_INTR0, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA), 
	GPIO_CFG(PYRAMID_GPIO_RAW_INTR1, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA), 
	GPIO_CFG(PYRAMID_GPIO_MCAM_SPI_DO, 1, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_8MA),
	GPIO_CFG(PYRAMID_GPIO_MCAM_SPI_DI, 1, GPIO_CFG_INPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_8MA),
	GPIO_CFG(PYRAMID_GPIO_MCAM_SPI_CS, 1 , GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_8MA),
	GPIO_CFG(PYRAMID_GPIO_MCAM_SPI_CLK, 1, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_8MA),
...
static uint32_t rawchip_off_gpio_table[] = {
	GPIO_CFG(PYRAMID_GPIO_MCAM_SPI_DO, 0, GPIO_CFG_INPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_8MA),
	GPIO_CFG(PYRAMID_GPIO_MCAM_SPI_DI, 0, GPIO_CFG_INPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_8MA),
	GPIO_CFG(PYRAMID_GPIO_MCAM_SPI_CS, 0, GPIO_CFG_INPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_8MA),
	GPIO_CFG(PYRAMID_GPIO_MCAM_SPI_CLK, 0, GPIO_CFG_INPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_8MA),
	...
	GPIO_CFG(PYRAMID_GPIO_RAW_INTR0, 0, GPIO_CFG_INPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA), 
	GPIO_CFG(PYRAMID_GPIO_RAW_INTR1, 0, GPIO_CFG_INPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA), 
...
static struct msm_camera_rawchip_info msm_rawchip_board_info = {
	.rawchip_reset	= PYRAMID_GPIO_RAW_RSTN,
	.rawchip_intr0	= MSM_GPIO_TO_INT(PYRAMID_GPIO_RAW_INTR0),
	.rawchip_intr1	= MSM_GPIO_TO_INT(PYRAMID_GPIO_RAW_INTR1),
	.rawchip_spi_freq = 27, 
	.rawchip_mclk_freq = 24, 
	.camera_rawchip_power_on = pyramid_rawchip_vreg_on,
	.camera_rawchip_power_off = pyramid_rawchip_vreg_off,
	.rawchip_use_ext_1v2 = pyramid_use_ext_1v2,
};
...
static uint16_t msm_cam_gpio_tbl[] = {
	...
	PYRAMID_GPIO_RAW_INTR0,
	PYRAMID_GPIO_RAW_INTR1,
	PYRAMID_GPIO_MCAM_SPI_CLK,
	PYRAMID_GPIO_MCAM_SPI_CS,
	PYRAMID_GPIO_MCAM_SPI_DI,
	PYRAMID_GPIO_MCAM_SPI_DO,
};
...
static struct msm_camera_sensor_platform_info sensor_s5k3h1gx_board_info = {
	...
	.sensor_reset	= 0,
	.sensor_pwd	= PYRAMID_GPIO_CAM_PWDN,
	.vcm_pwd	= PYRAMID_GPIO_CAM_VCM_PD,
	.vcm_enable	= 1,
};
